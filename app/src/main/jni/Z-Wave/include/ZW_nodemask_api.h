 ...
 * Last Changed:     $Date: 2013-06-10 09:08:11 +0200 (Mon, 10 Jun 2013) $
 *
 ****************************************************************************/
...
extern void                     /*RET   Nothing                 */
 ZW_NodeMaskSetBit(BYTE_P pMask,    /* IN   pointer nodemask        */
                   BYTE bNodeID);   /* IN   node to set in nodemask */
...
**--------------------------------------------------------------------------*/
extern void                     /*RET   Nothing                   */
 ZW_NodeMaskClearBit(BYTE_P pMask,  /* IN   nodemask                  */
                     BYTE bNodeID); /* IN   node to clear in nodemask */
...
**--------------------------------------------------------------------------*/
extern void                     /*RET   Nothing             */
 ZW_NodeMaskClear(BYTE_P pMask, /* IN   nodemask            */
                  BYTE bLength);    /* IN   length of nodemask  */
...
extern BYTE                     /*RET   Number of bits set in nodemask  */
 ZW_NodeMaskBitsIn(BYTE_P pMask,    /* IN   pointer to nodemask             */
                   BYTE bLength);   /* IN   length of nodemask              */
...
extern BYTE                     /*RET   ZERO if not in nodemask, NONEZERO if in nodemask  */
 ZW_NodeMaskNodeIn(BYTE_P pMask,    /* IN   pointer to nodemask to check for bNode            */
                   BYTE bNode); /* IN   bit number that should be checked                 */
...
**
**--------------------------------------------------------------------------*/
extern BYTE ZW_NodeMaskGetNextNode(BYTE currentNodeId, BYTE_P pMask);
