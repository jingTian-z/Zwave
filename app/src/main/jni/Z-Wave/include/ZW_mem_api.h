 ...
 * Revision:         $Revision: 27022 $
 * Last Changed:     $Date: 2013-09-18 15:30:40 +0200 (Wed, 18 Sep 2013) $
 *
 ****************************************************************************/
...
extern void                     /*RET Nothing          */
 MemoryGetID(BYTE * homeID,     /*OUT  Home-ID pointer            */
...
extern BYTE                     /*RET Data          */
 MemoryGetByte(WORD offset);    /*IN   Application area offset            */
...
extern BYTE                     /*RET FALSE if write buffer full    */
 MemoryPutByte(WORD offset,     /*IN   Application area offset   */
...
**--------------------------------------------------------------------------*/
extern void                     /*RET Nothing          */
 MemoryGetBuffer(WORD offset,   /*IN   Application area offset   */
                 BYTE * buffer, /*IN   Buffer pointer            */
...
extern BYTE                     /*RET FALSE if the buffer put queue is full          */
 MemoryPutBuffer(WORD offset,   /*IN   Application area offset   */
                 BYTE * buffer, /*IN   Buffer pointer            */
...
**--------------------------------------------------------------------------*/
extern BYTE                     /*RET FALSE if the buffer put queue is full       */
 ZW_MemoryPutBuffer(WORD offset,    /* IN Application area offset   */
                    BYTE * buffer,  /* IN Buffer pointer            */
                    WORD length);   /* IN Number of bytes to copy   */
...
**--------------------------------------------------------------------------*/
extern void                     /* RET  Nothing */
 __ZW_memcpy(BYTE length,       /* IN   Number of bytes to copy */
...
extern BYTE                     /* RET  0 if *src and *dst are equal, else 1 */
 __ZW_memcmp(BYTE length,       /* IN   Number of bytes to compare */
...
**--------------------------------------------------------------------------*/
void                            /*RET Nothing */
 __ZW_memset(BYTE val,          /* IN Value to fill buffer with */
